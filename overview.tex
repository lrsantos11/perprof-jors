...
\subsection*{Implementation and architecture}
    ...
    \begin{enumerate}
      \item parse the options passed as arguments, creating a
        structure with all information;
      \item parse and process input files, using
         performance function definition to create data to be plotted;
      \item use the chosen backend to plot data.
    \end{enumerate}
...
\end{verbatim}
    ...
    and semilog options. In this case, we selected around 120
